...
import { Col, Container, Row, Alert, ProgressBar, Button, Form } from 'react-bootstrap';
            ...
            <Col md={12} className="custom-box-banner">
              ...
              <div className="box-form box-form-small full-border">
                ...
                <div className="bottom-form-small">
                  ...
                  <Row className="mb-4">
                    <Col>
                      <p className="des-final mb0">What is your current employment status?</p>
                    </Col>
                  </Row>
                  <Row className="mb-4">
                    <Col md={6}>
                      <Form.Check
                          ...
                          type="checkbox"
                          id="checkbox-1"
                          label={<span className="color-black">I’m a home owner</span>}
                          onChange={() => {}}
                    ...
                    <Col md={6}>
                      <Form.Check
                          ...
                          type="checkbox"
                          id="checkbox-2"
                          label={<span className="color-black">I’m renting my home</span>}
                          onChange={() => {}}
                          className='custom-checkbox-v2'
                      />
                    </Col>
                    <Col md={6}>
                      <Form.Check
                          ...
                          type="checkbox"
                          id="checkbox-3"
                          label={<span className="color-black">I’m living with my parents</span>}
                          onChange={() => {}}
                          className='custom-checkbox-v2'
                      />
                    </Col>
